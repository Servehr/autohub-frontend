...
import { ScoreStudentScore, UserTestTheoryAnswers } from '@/apis/backend/course';
import { useQuery } from 'react-query';
import toast from "react-hot-toast";


export const AddTestTheoryMark = ({onClick, openAddTestTheoryMark, student})  =>
{
        ...
        const { data, isLoading, refetch, isRefetching } = useQuery([`use-test-answers`], () => UserTestTheoryAnswers(userId), { cacheTime: 0 })
        ...
        return (
                <Modal onClick={onClick} isOpen={openAddTestTheoryMark} wrapperWidth={1200} margin={'60px auto 0px auto'}
                >                        
                        {
