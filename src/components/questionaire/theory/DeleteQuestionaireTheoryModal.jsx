...
import { DeleteTestQuestionairesTheory } from '@/apis/backend/questionaires';
import { BeatLoader } from "react-spinners";


export const DeleteTestQuestionaireTheoryModal = ({onClick, id, name, deleteFolder, courseId})  =>
{
