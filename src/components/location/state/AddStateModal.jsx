...
import { AddSteate } from '@/apis/backend/location';


export const AddStateModal = ({onClick, addState, country})  =>
{
        ...
        {            
                const data = { country_id: country?.id,  ijinle_id: country?.id,  name: countryState }
                AddSteate(data)
                .then((res) => 
                {
