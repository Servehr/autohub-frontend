...
import { UpdateSteateLevel } from '@/apis/backend/location';


export const PlaceStateLevel = ({onClick, placeStateLevel, stateLevel})  =>
{
        const [trimRate, setTrimRate] = useState(stateLevel?.rate)
        const [stateId, setStateId] = useState(stateLevel?.id)
        ...
        {   
                const data = { id: stateId, rate: Number(trimRate) }
                UpdateSteateLevel(data)
                .then((res) => 
                {
                        onClick()
                })
        ...
        return (
                <Modal onClick={onClick} isOpen={placeStateLevel} wrapperWidth={800} margin={'100px auto 0px auto'}>
                                ...
                                <div className='col-span-12 pb-2 overflow-auto justify-center h-fit py-2 item-center'>
                                        <>                                                
                                                <div className="p-1 mt-1">
                                                        <h1 className='font-bold text-lg mb-5'>Increase State Visibility</h1>
