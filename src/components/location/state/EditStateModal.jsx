...
import { UpdateSteate } from '@/apis/backend/location';


export const EditStateModal = ({onClick, editCountryModal, country})  =>
{
        const [countryId, setCountryId] = useState(country.id)
        const [countryNamee, setCountryName] = useState(country.name)
        ...
        const updateFaqData = () => 
        {
                const data = { stateId: countryId, stateName: countryNamee  }
                UpdateSteate(data)
                .then((res) => 
                {
                        onClick()
                                        ...
                                        <>                                                
                                                <div className="p-1 mt-1">
                                                        ...
                                                        <div className="w-full d-flex-row md:flex mt-1 gap-5 p-2">
                                                                ...
                                                                }} type="text" id="stateName" defaultValue={countryNamee}  name="stateName" 
                                                                placeholder='' 
