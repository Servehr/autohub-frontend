...
import { DeleteExamQuestionTheory, DeleteTestQuestionTheory } from '@/apis/backend/questions';
import { Modal } from '@/components/Modal';


export const DeleteTheoryQuestion = ({onClick, data, deleteQuestion})  =>
{
        ...
        const deleteQuestionn = () => 
        {
                ...
                const data = { id: theId }
                console.log(data.id)
                DeleteExamQuestionTheory(Number(data.id))
                .then((res) => 
                {
                        onClick(Math.random())
                })
