...
import { UpdateExamQuestion, UpdateTestQuestion } from '@/apis/backend/questions';
import { BeatLoader } from "react-spinners";


export const EditExamQuestionModal = ({onClick, data, editExamQuestion})  =>
{
        ...
        return (
                <Modal onClick={onClick} isOpen={editExamQuestion} wrapperWidth={800} margin={'80px auto 0px auto'}>
