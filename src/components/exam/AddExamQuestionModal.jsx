...
import { AddExam, AddTest } from '@/apis/backend/questions';


export const AddExamQuestionModal = ({onClick, openExamQuestionaire, folderName})  =>
{
        ...
        return (
                <Modal onClick={onClick} isOpen={openExamQuestionaire} wrapperWidth={800} margin={'80px auto 0px auto'}>
