...
export default function CountDownTimerExamTheory({ seconds, question, code })
{
    localStorage.setItem("text-exam-thoeory-ques", question)
    localStorage.setItem("exam-theory-code", code)
    ...
    useEffect(() => {
        if(countdown <= 0)
        {
            ...
            advertState.setForceExamTheory('yes')
            // alert("End")
