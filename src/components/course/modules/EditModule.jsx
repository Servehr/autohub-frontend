...
import { UpdateModule } from '@/apis/backend/course';


export const EditModule = ({onClick, openEditModule, modulez})  =>
{
        ...
        {
                const data = { id: moduleId, name: moduleNamee  }
                UpdateModule(data)
                .then((res) => 
                {
                        onClick()
        ...
        return (
                <Modal onClick={onClick} isOpen={openEditModule} wrapperWidth={800} margin={'100px auto 0px auto'}>
                                ...
                                <div className='col-span-12 pb-2 overflow-auto justify-center h-fit py-2 item-center'>
                                        <>                                                
                                                <div className="p-1 mt-1">
                                                        <h1 className='font-bold text-lg mb-1'>Edit Module</h1>     
                                                        <div className="w-full d-flex-row md:flex mt-1 gap-5 p-2">
                                                                <input onChange={(e) => {
                                                                        setModuleName(e.target.value)
                                                                }} type="text" id="moduleName" defaultValue={moduleNamee}  name="moduleName" 
