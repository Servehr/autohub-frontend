...
import { AddManufacturerModel } from '@/apis/backend/product';


export const AddBrand = ({onClick, openBrand, manufacId})  =>
{
        const [productBrandName, setBrandName] = useState("")
        ...
        {   
                const data = { make_id: manufacId, code: productBrandName.toUpperCase(), title: productBrandName }
                AddManufacturerModel(data)
                .then((res) => 
                {
                        onClick()
                })
        ...
        return (
                <Modal onClick={onClick} isOpen={openBrand} wrapperWidth={800} margin={'100px auto 0px auto'}>
                                ...
                                <div className='col-span-12 pb-2 overflow-auto justify-center h-fit py-2 item-center'>
                                        <>                                                
                                                <div className="p-1 mt-1">
                                                        <h1 className='font-bold text-lg mb-5'>Add Brand</h1>
