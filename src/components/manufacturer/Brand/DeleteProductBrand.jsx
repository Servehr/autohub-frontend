...
import { RemoveModel } from '@/apis/backend/product';


export const DeleteProductBrand = ({onClick, openDeleteBrand, modelId})  =>
{
        const cancelModal = () => 
        {
                onClick(true)
        ...
        return (
                <Modal onClick={onClick} isOpen={openDeleteBrand} wrapperWidth={800} margin={'100px auto 0px auto'}>
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll d-flex justify-center item-center'>
                                <h1 className='flex w-full justify-center items-center font-bold text-lg mb-10 mx-auto'>You are about to delete brand: {modelId?.title}</h1>
