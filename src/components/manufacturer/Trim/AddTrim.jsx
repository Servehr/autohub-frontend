...
import { AddModelTrim } from '@/apis/backend/product';


export const AddTrim = ({onClick, openAddTrim, modelId, manufacturerId})  =>
{
        ...
        console.log({ modelId, manufacturerId })

        const addTrimToModel = async () => 
        {   
                const data = { make_id: manufacturerId,  model_id: modelId, name: trimName }
                AddModelTrim(data)
                .then((res) => 
                {
                        onClick()
        ...
        return (
                <Modal onClick={onClick} isOpen={openAddTrim} wrapperWidth={800} margin={'100px auto 0px auto'}>
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll justify-center item-center'>
                                ...
                                <div className='col-span-12 pb-2 overflow-auto justify-center h-fit py-2 item-center'>
                                        <>                                                
                                                <div className="p-1 mt-1">
                                                        <h1 className='font-bold text-lg mb-2'>Add Trim</h1>
                                                        <div className="w-full d-flex md:flex">
                                                                <input onBlur={(e) => {
                                ...
                                <div className="items-center sm:flex flex justify-between mb-2 mx-1">
                                        <button  
