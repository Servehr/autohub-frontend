...
import { UpdateAcademicSession } from '@/apis/backend/academic';


export const EditSessionModal = ({onClick, openEditAcademicSession, sessionId})  =>
{
        ...
        {
                const data = { id: id, name: sessionName }
        ...
        return (
                <Modal onClick={onClick} isOpen={openEditAcademicSession} wrapperWidth={800} margin={'100px auto 0px auto'}>
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll justify-center item-center'>
                                ...
                                <div className='col-span-12 pb-2 overflow-auto justify-center h-fit py-2 item-center'>
                                        <>                                                
                                                <div className="p-1 mt-1">
                                                        <h1 className='font-bold text-lg mb-10'>Edit Academic Sesion</h1>
                                                        <div className="w-full d-flex-row md:flex mt-1 gap-5 p-2">
                                                                {/* <span className="font-bold text-sm">Title</span> */}
                                                                <input onChange={(e) => {
                                                                        setSessionName(e.target.value)
                                                                }} type="text" id="sessionName" defaultValue={sessionName}  name="sessionName" 
                                                                placeholder='' 
                                ...
                                <div className="items-center gap-5 mt-2 sm:flex flex justify-between mx-1 -mb-4">
                                        <button  
                                                ...
                                                onClick={() => {
                                                        onClick(openEditAcademicSession)
                                                }}
                                        >
                                                        Close
                                        </button>
