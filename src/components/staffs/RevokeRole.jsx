...
export const RevokeRole = ({onClick, openRevoke, userId})  =>
{
        ...
        return (
                <Modal onClick={onClick} isOpen={openRevoke} wrapperWidth={800} margin={'80px auto 0px auto'}>
                        ...
                        <div className='col-span-12 pb-2 justify-center h-fit py-2 item-center -mt-5'>
                                <>                                                
                                        <div className="p-1 mt-1">
                                                <h1 className='font-bold text-lg mb-5 p-3 bg-blue-100 rounded-lg'>Revoke User Role</h1>
