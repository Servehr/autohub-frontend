...
import { UpdateExamQuestionaires, UpdateExamQuestionairesTheory } from '@/apis/backend/questionaires';
import { BeatLoader } from "react-spinners";
import { Modal } from '@/components/Modal';


export const EditExamTheoryQuestionaireModal = ({onClick, editFolder, description, courseId, id, name})  =>
{
                                ...
                                <div className='col-span-12 pb-2 overflow-auto justify-center h-fit py-2 item-center'>
                                        <>                                                
                                                <div className="p-1 mt-1">
                                                        <h1 className='font-bold text-lg mb-5'>Rename Exam Folder</h1>
