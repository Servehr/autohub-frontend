...
export const AssessmentModal  = ({courseFaq, onClick, editDataCourse, assessment})  =>
{
        const [loading, setIsLoading] = useState(false)
        const [courseName, setQuestion] = useState(editDataCourse.name)
        const [courseFaqId, setCourseFaqId] = useState(editDataCourse.id)
        ...
        return (
                <Modal onClick={onClick} isOpen={assessment} wrapperWidth={800} margin={'100px auto 0px auto'}>
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll justify-center item-center'>
                                ...
                                <h1 className='font-bold text-lg mb-10 flex items-center bg-blue-100 p-3 rounded-md justify-center'>{courseName}</h1>   
