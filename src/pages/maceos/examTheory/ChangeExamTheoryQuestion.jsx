...
export const ChangeExamTheoryQuestion = ({onClick, question, openExamTheoryAnswerToEdit, studentValue, courseId, questionId, currentPage})  =>
{
        ...
        return (
                <Modal onClick={onClick} isOpen={openExamTheoryAnswerToEdit} wrapperWidth={900} margin={'100px auto 0px auto'}>
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll justify-center item-center'>
                                ...
                                <div className="items-center gap-5 mt-2 sm:flex flex justify-between mb-2 mx-1 mt-3">
                                        <button  
                                                ...
                                                onClick={() => {
                                                        onClick(!openExamTheoryAnswerToEdit)
                                                }}
                                        >
                                                        Cancel
                                        </button>
