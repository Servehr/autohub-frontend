...
export const AnswerExamTheoryQuestion = ({onClick, question, OpenAnswerExamTheoryQuestion, courseId, questionId, currentPage})  =>
{
        ...
        return (
                <Modal onClick={onClick} isOpen={OpenAnswerExamTheoryQuestion} wrapperWidth={900} margin={'100px auto 0px auto'}>
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll justify-center item-center'>
                                ...
                                <div className="items-center gap-5 mt-2 sm:flex flex justify-between mb-2 mx-1 mt-3">
                                        <button  
                                                ...
                                                onClick={() => {
                                                        onClick(!OpenAnswerExamTheoryQuestion)
                                                }}
                                        >
                                                        Cancel
                                        </button>
