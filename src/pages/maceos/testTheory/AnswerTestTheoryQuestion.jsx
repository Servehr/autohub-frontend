...
export const AnswerTestTheoryQuestion = ({onClick, question, openAnswerTestTheoryQuestion, courseId, questionId, currentPage})  =>
{
        ...
        {  
                ...
                if(checkIfPresent === -1)
                {          
                    let answer = { user_id: Number(localStorage.getItem("authenticatedId")), course_id: courseId, test_theory_question_id: questionId, answer: answerQuestion, position: currentPage }
        ...
        return (
                <Modal onClick={onClick} isOpen={openAnswerTestTheoryQuestion} wrapperWidth={900} margin={'100px auto 0px auto'}>
                        <div className='col-span-12 pt-1 pb-5 overflow-y-auto xm:overflow-y-scroll justify-center item-center'>
                                ...
                                <div className="items-center gap-5 mt-2 sm:flex flex justify-between mb-2 mx-1 mt-3">
                                        <button  
                                                ...
                                                onClick={() => {
                                                        onClick(!openAnswerTestTheoryQuestion)
                                                }}
                                        >
                                                        Cancel
                                        </button>
