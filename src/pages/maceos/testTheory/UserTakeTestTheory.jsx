...
import { SubmitTestObjective, TestCourseTheoryQuestions } from "@/apis/backend/course";
import { appStore } from "@/state/appState";


export default function UserTakeTestTheory() 
{
        ...
        <div className="col-span-12">
              ...
              { !isLoading && !isRefetching && (data?.data.length > 0) && (data?.message < 1) &&
                 <div className="w-full mb-1">
                      ...
                      >          
                          <div className="font-bold text-xl mb-4 text-green-700 mt-28 md:mt-0 p-3 bg-green-100 col-span-12">Course:  {data?.plus}</div>
                      </div>
