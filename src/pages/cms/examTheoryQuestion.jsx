...
export default function ExamTheoryQuestion()
{
    const { id } = useParams()
    // alert(id)
    ...
    const [addTheoryQuestion, setOpenAddTheoryQuestion] = useState(false)
  ...
  return ( 
        <>
            <div className='w-full flex h-full bg-blue-500'>
                ...
                <div className='bg-white md:w-10/12 lg:10/12 w-full lg:flex-row px-5 bg-blue-500'>
                    ...
                    <div className="w-full justify-between p-3 mt-2 flex bg-green-100 -mb-3 items-center rounded-lg">                        
                        ...
                        <div className="font-bold px-3 py-2 bg-green-900 text-white rounded-md cursor-pointer" onClick={() => setOpenAddTheoryQuestion(true)}>Add Question</div>
                    </div>
            ...
            {
                editQuestion && <EditTheoryQuestion data={dataToEdit} editQuestion={editQuestion} onClick={() => {
                        refetch()
            ...
            {
                deleteQuestion && <DeleteTheoryQuestion data={dataToDelete} deleteQuestion={deleteQuestion} onClick={() => {
                        refetch()
