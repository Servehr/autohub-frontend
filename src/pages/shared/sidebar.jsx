    ...
    <div className={`transition ease-in-out fixed w-12/12 lg:w-2/12 md:w-2/12 md:visible lg:visible md:block z-50 md:w-2/12 w-8/12 drop-shadow-lg scrollbar-thin scrollbar-thumb-indigo-300 overflow-y-auto scrollbar-track-pink h-screen justify-center items-center`} style={{background: "#048749" }}>
        {/* <div className="w-12/12 lg:w-2/12 md:w-2/12 md:visible lg:visible md:block md:visible lg:visible scrollbar-thin scrollbar-thumb-indigo-300 overflow-y-auto scrollbar-track-pink" style={{background: "#048749", zIndex: 999 }}> */}
          ...
          backgroundColor: "pink"
                    ...
                    {/* #f3f2ff */}
                    <li className="border-b-2  shadow-md border-green-800 mgmnt pl-2">
                        <NavLink to="/a/academic-session" className="w-5/5 relative justify-center items-end flex p-4 pl-1 text-sm hover:bg-blue-900">                             
                            ...
                            <span className='w-4/5 hover:text-white-500 text-white' style={{fontSize: '13px'}}>Academic Session</span>             
                            {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="h-4 -mt-3 w-1/5">
                                <path fillRule="evenodd" d="M12.53 16.28a.75.75 0 0 1-1.06 0l-7.5-7.5a.75.75 0 0 1 1.06-1.06L12 14.69l6.97-6.97a.75.75 0 1 1 1.06 1.06l-7.5 7.5Z" clipRule="evenodd" />
                            </svg> */}
                        </NavLink>
                    ...
                    <li className="border-b-2  shadow-md border-green-800 mgmnt">
                        <NavLink to="/a/package" className="w-5/5 relative justify-center items-end flex p-4 pl-3 text-sm hover:bg-blue-900">                            
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-4 h-4 mr-3">
                    ...
                    {/* <li className="border-b-2  shadow-md border-green-800 mgmnt">
                        <NavLink to="/a/result" className="w-5/5 relative justify-center items-end flex p-4 pl-3 text-sm hover:bg-blue-900">                            
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-4 h-4 mr-3 ">
                    ...
                    {/* <li className="border-b-2  shadow-md border-green-800 mgmnt">
                        <NavLink to="/a/finance" className={`w-5/5 relative justify-center items-end flex p-4 pl-3 text-sm hover:bg-blue-900`}>                            
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-4 h-4 mr-3 ">
                    ...
                    {/* <li className="border-b-2  shadow-md border-green-800 mgmnt">
                        <NavLink to="/a/expenses" className="w-5/5 relative justify-center items-end flex p-4 pl-3 text-sm hover:bg-blue-900" activeClassName="active">                            
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-4 h-4 mr-3 ">
                    ...
                    {/* <li className="border-b-2  shadow-md border-green-800 mgmnt">
                        <NavLink to="/a/request-item" className="w-5/5 relative justify-center items-end flex p-4 pl-3 text-sm hover:bg-blue-900">                            
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-4 h-4 mr-3">
                            <path d="M21.731 2.269a2.625 2.625 0 0 0-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 0 0 0-3.712ZM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 0 0-1.32 2.214l-.8 2.685a.75.75 0 0 0 .933.933l2.685-.8a5.25 5.25 0 0 0 2.214-1.32l8.4-8.4Z" />
                            <path d="M5.25 5.25a3 3 0 0 0-3 3v10.5a3 3 0 0 0 3 3h10.5a3 3 0 0 0 3-3V13.5a.75.75 0 0 0-1.5 0v5.25a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5V8.25a1.5 1.5 0 0 1 1.5-1.5h5.25a.75.75 0 0 0 0-1.5H5.25Z" />
                        </svg>
                    ...
                    {/* <li className="border-b-2  shadow-md border-green-800 mgmnt">
                        <NavLink to="/a/settings" className="w-5/5 relative justify-center items-end flex p-4 pl-3 text-sm hover:bg-blue-900">                            
