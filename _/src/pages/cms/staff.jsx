...
export default function Staff()
{
  ...
  return ( 
        <>
            <div className='w-full flex'>
                ...
                <div className='bg-white md:w-10/12 lg:10/12 w-12/12 lg:flex-row px-5'>
                    ...
                    <div className="w-full justify-between p-3 flex space-x-10 -mb-3 items-center">                        
                        ...
                        <div className="font-bold px-3 py-2 bg-green-900 text-white rounded-md cursor-pointer" onClick={() => setOpenStaff(true)}>Add Staff</div>
                    </div>
            ...
            { openStaff && <AddStaffModal onClick={(e) => {
                                                setOpenStaff(false) 
                                                setClickTable(e) 
                                            }
                                        } openStaff={openStaff}  
