...
export default function DealerPost()
{
    ...
    const  data  = [
        { product: 'Grace', price: 'Kelechi', condition: 'grace2349@gmail.com', status: '09083847543', views: 34 },
        { product: 'Ibrahim', price: 'Sanusi', condition: 'sanusi0987@gmail.com', status: '07023541276', views: 20 },
        { product: 'Peter', price: 'Ederson', condition: 'peterson@yahoo.com', status: '09023765432', views: 21 },
        { product: 'Michael', price: 'John', condition: 'michaeljohnson@mail.com', status: '07023541276', views: 5 },
        { product: 'Bernald', price: 'Festus', condition: 'festuswre@gmail.com', status: '08078654231', views: 10 }
    ]
        ...
        <>
            <div className='w-full flex'>
                ...
                <div className='bg-white md:w-10/12 lg:10/12 w-12/12 lg:flex-row px-5'>
                    ...
                    <div className="w-full justify-between p-3 -mt-2 flex space-x-10 -mb-2 items-center">                        
                        <div className="bg-white py-3 mt-1">
                            <h1 className="font-bold text-2xl">All Post Made By Dealer xxx
                    ...
                    <div className="w-full p-3 mb-10" style={{ marginBottom: '100px' }}>
                        ...
                        )} */}
                        {
                            ...
                            (data.length > 0) &&  <DynamicTable 
                                                                                header={['Product', 'Price', 'Condition', 'Status', 'Views', 'Actions']} 
                                                                                columns={columns}
                                                                                data={data}
                                                                                onClick={(e) =>  {
                                                                                    console.log(e)
