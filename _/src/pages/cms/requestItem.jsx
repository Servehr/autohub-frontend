...
export default function RequestItems()
{
    ...
    const  data  = [
        { by: 'Emmanuel Austin', item: 'Grace', amount: 'Kelechi', date: 'grace2349@gmail.com', status: 'approved' },
        { by: 'Musa Bayero', item: 'Ibrahim', amount: 'Sanusi', date: 'sanusi0987@gmail.com', status: 'declined' },
        { by: 'Kazeem Afolayan', item: 'Peter', amount: 'Ederson', date: 'peterson@yahoo.com', status: 'pending' },
        { by: 'Temitope Rebecca', item: 'Michael', amount: 'John', date: 'michaeljohnson@mail.com', status: 'pending' },
        { by: 'Ngozi Adamma', item: 'Bernald', amount: 'Festus', date: 'festuswre@gmail.com', status: 'approved' }
    ]
                    ...
                    <div className="w-full p-3 mb-10" style={{ marginBottom: '100px' }}>
                        ...
                        )} */}
                        {
                            ...
                            (data.length > 0) &&  <DynamicTable 
                                                                                header={['By', 'Item', 'Amount', 'Date', 'Status', 'Actions']} 
                                                                                columns={columns}
                                                                                data={data}
                                                                                onClick={(e) =>  {
                                                                                    console.log(e)
