...
export default function Finance()
{
    ...
    const  data  = [
        { firstname: 'Grace', surname: 'Kelechi', email: 'grace2349@gmail.com', phoneNumber: '09083847543', dated: '21-02-2023' },
        { firstname: 'Ibrahim', surname: 'Sanusi', email: 'sanusi0987@gmail.com', phoneNumber: '07023541276', dated: '23-11-2022'  },
        { firstname: 'Peter', surname: 'Ederson', email: 'peterson@yahoo.com', phoneNumber: '09023765432', dated: '24-03-2024'  },
        { firstname: 'Michael', surname: 'John', email: 'michaeljohnson@mail.com', phoneNumber: '07023541276', dated: '04-04-2023'  },
        { firstname: 'Bernald', surname: 'Festus', email: 'festuswre@gmail.com', phoneNumber: '08078654231', dated: '19-10-2024'  }
    ]
        ...
        <>
            <div className='w-full flex'>
                ...
                <div className='bg-white md:w-10/12 lg:10/12 w-12/12 lg:flex-row px-5'>
                    ...
                    <div className="w-full justify-between py-3 flex space-x-10 -mb-3 items-center">                        
                    ...
                    <div className="w-full p-3 mb-10" style={{ marginBottom: '100px' }}>
                        ...
                        )} */}
                        {
                            ...
                            (data.length > 0) &&  <DynamicTable 
                                                                                header={['FirstName', 'Surname', 'Email', 'Phone Number', 'Date', 'Actions']} 
                                                                                columns={columns}
                                                                                data={data}
                                                                                onClick={(e) =>  {
                                                                                    console.log(e)
