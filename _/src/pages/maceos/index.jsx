...
export default function MACEOS() 
{
    ...
    // console.log(userId)
    const { data, isLoading, refetch, isRefetching, isError } = useQuery(["get-authenticated-user", userId], () => AuthenticatedUser(userId), { refetchOnWindowFocus: true, staleTime: Infinity, retry: 2 })
                                                ...
                                                <div className="w-full mt-5">
                                                    <div className="flex flex-wrap -m-2 mt-2 mb-2 md:mx-5 mx-2">
                                                        ...
                                                        <div className="p-2 md:w-1/2 w-full">
                                                            ...
                                                            <input 
                                                                {...register("surname")}  
                                                                type="text" id="surname" defaultValue={data?.lastname}  name="surname" placeholder="Enter Your Lastname" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 text-sm py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                                    ...
                                                    <div className="flex flex-wrap -m-2 mt-2 mb-1 md:mx-5 mx-2">
                                                        <div className="p-2 md:w-1/2 w-full">
                                                            ...
                                                            <input 
                                                                {...register("middlename")}  
                                                                type="text" id="middlename" defaultValue={data?.middlename} name="middlename" 
                                                        ...
                                                        <div className="p-2 md:w-1/2 w-full">
                                                            ...
                                                            <input 
                                                                {...register("phoneno")}  
                                                                type="number" id="phoneno" defaultValue={data?.phoneno} name="phoneno" placeholder="Enter Your phone Number" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 text-sm leading-8 transition-colors duration-200 ease-in-out" />
                                                    ...
                                                    <div className="flex flex-wrap -m-2 mt-2 mb-1 md:mx-5 mx-2">
                                                        <div className="p-2 md:w-1/2 w-full">
                                                            ...
                                                            <input 
                                                                {...register("email")}  
                                                                type="email" id="email" defaultValue={data?.email}  name="email" placeholder="Enter Your Email" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 text-sm py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                                            <p className="text-sm text-brandRed font-bold">{errors.email?.message}</p>
                                                        </div>
                                                        <div className="p-2 md:w-1/2 w-full">
                                                    ...
                                                    <div className="flex flex-wrap -m-2 mb-2 md:mx-5 mx-2">
                                                        <div className="p-2 md:w-1/2 w-full">
                                                            ...
                                                            <p className="text-sm text-brandRed font-bold">{errors.password?.message}</p>
                                                        </div>
                                                        <div className="p-2 md:w-1/2 w-full">
                                                            ...
                                                            <p className="text-sm text-brandRed font-bold">{errors.confirm_password?.message}</p>
                                                        </div>
                                                    </div>
